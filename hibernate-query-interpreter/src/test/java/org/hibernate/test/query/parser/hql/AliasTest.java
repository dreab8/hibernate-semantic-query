...
public class AliasTest {
	...
	public void testAliasCollisionInSelect() {
		// doable in sql, a problem occurs if b is referred in a order by clause
		final String query = "select a.address as b, a.name as b from Anything a";
		interpretQuery( query );
	}

	@Test(expected = AliasCollisionException.class)
	public void testAliasesShouldFail() {
	...
	@Test
	public void testAliasesInSelect() {
	...
	// ?????????????? expected warning ??????????????????????
	@Test(expected = AliasCollisionException.class)
	public void testAliasInSelectCollision() {
		final String query = "select a.basic as a from Anything as a";
		interpretQuery( query );
	}

	@Test
	public void testAliasInTwoFromClauseSpace() {
		final String query = "select a as a from Anything as a, SomethingElse as b where b.basic = 2 ";
		final QuerySpec querySpec = interpretQuery( query ).getQuerySpec();
	...
	public void testAliasCollisionInFromClause() {
		final String query = "select a as a from Anything as a, SomethingElse as a ";
		interpretQuery( query );
	}

	@Test
	public void testDifferentAliasInSubquery() {
	...
	@Test
	public void testSameAliasInSubquery() {
	...
	@Test
	public void testSubqueryUsingAliasInMainQuery() {
	...
	@Test
	public void testNestedSubqueriesUsingIdentificationVariableDefinedInRootQuery2() {
		final String query = "select a from Anything a where a.basic in " +
				"( select b.basic1 from SomethingElse b where b.basic = " +
	...
	@Test(expected = AliasCollisionException.class)
	public void testAliasCollisionSubQuery() {
	...
	@Test(expected = IllegalStateException.class)
	public void testAliasCollisionSubQuery2() {
		final String query = "select a.address as b, a.basic as c from Anything a where a.basic2 in " +
	...
	@Test(expected = IllegalStateException.class)
	public void testDefineSameAliasInJoin() {
	...
	@Test
	@Ignore
	public void testUseinSelectOfAliasDefinedInSubquery() {
		final String query = "select a.basic as a, b from Anything a where a.basic1 in (select b.basic3 from SomethingElse as b)";
		interpretQuery( query );
	}
	...
	@Test
	@Ignore
	public void testSubqueryUsingInSelectAnAliasDefinedInRootFrom() {
		final String query = "select a  from Anything a where a.basic in ( select a.basic from SomethingElse b where a.basic = b.basic2)";
		interpretQuery( query );
	}
	...
	@Test
	public void testResultVariabletReferenceInOrderBy1() {
...
//		checkAttributeReferenceExpression( querySpec, 0, "com.acme.Entity", "basic", "b" );
	...
	private void checkFromClause(QuerySpec querySpec, int position, String typeName, String alias) {
		...
		FromElementSpace fromElementSpace = fromClause.getFromElementSpaces().get( position );
	...
	private void checkAttributeReferenceExpression(
		...
		Selection selection = selections.get( position );
	...
	private void checkElementSelection(QuerySpec querySpec, int position, String typeName, String alias) {
